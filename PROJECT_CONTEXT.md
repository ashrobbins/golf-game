...
- Working tree is clean as of this doc update. Four commits landed this session (`99ce1fb`, `9fb21ac`, `f33970e`, `412c3f5`) — see session history items 17–21 below for what's in each. Not yet pushed to `origin/main`.
